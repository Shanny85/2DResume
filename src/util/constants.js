...
export const dailogueData = {
    ...
    Here is my <a href="https://github.com/Shanny85" target="_blank">Github</a>!`,
  ...
  I also make game programming tutorials on YouTube. Go sub to <a href="#" target="_blank">my channel</a>! (If you like the content)
  You'll learn how I built this portfolio you're currently playing through!`,
   ...
   <a href="#" target="_blank">Theprimeagen</a>, <a href="#" target="_blank">Theo - t3.gg</a>,
  <a href="#" target="_blank">PirateSoftware</a> (sometimes) and <a href="#" target="_blank">Melkey</a>!`,
  ...
  Contact me at naickershanon@gmail.com if you have any interesting job opportunities!`,
  ...
  Kaboom.js by watching some of my tutorials <a href="#" target="_blank">here</a>.`,
  ...
  I probably only read one of them. Who else compulsively buys technical books without ever finishing them?`,
    exit: `If you want to exit Shanon Naicker's portfolio, just close the tab.`,
